// To parse this data:
//
//   import { Convert, GifsSearchResponse } from "./file";
//
//   const gifsSearchResponse = Convert.toGifsSearchResponse(json);
//
...
export enum Username {
    Empty = "",
    JasonClarke = "jason-clarke",
    Leroypatterson = "leroypatterson",
    Viralhog = "viralhog",
}
...
export class Convert {
    public static toGifsSearchResponse(json: string): GifsSearchResponse {
        return cast(JSON.parse(json), r("GifsSearchResponse"));
    }

    public static gifsSearchResponseToJson(value: GifsSearchResponse): string {
        return JSON.stringify(uncast(value, r("GifsSearchResponse")), null, 2);
    }
}
